...
export const WIZARD_STEPS: readonly WizardStep[] = [
  {
    ...
    intro:
      'הפרטים האלה מופיעים על כל קבלה ובכותרת כל דוח. שם בית הכנסת הוא השדה היחיד שחובה למלא – את השאר אפשר להשלים בהמשך. בסוף הצעד נשאל גם איך לנהל את שם החבר: זו החלטה שכדאי לקבל לפני החבר הראשון, אף שאפשר לשנות אותה בכל עת.',
    keys: [
      'synagogue_name',
      'synagogue_city',
      'synagogue_address',
      'synagogue_phone',
      'association_number',
      // F-13 – השאלה שכדאי לשאול לפני שמוזן חבר ראשון. המעבר בין
      // המצבים אפשרי תמיד, אבל אחרי אלף חברים הוא כרוך בהשלמה ידנית חבר-חבר.
      'member_name_mode',
    ],
  },
  {
