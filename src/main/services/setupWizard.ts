 ...
 * חובה – ויצא. שנת הכספים, תיקיית הגיבוי ומספר הקבלה הראשון נשארו על
...
export const WIZARD_STEPS: readonly WizardStep[] = [
  ...
  },
  {
    ...
    title: 'גיבוי',
    intro:
      'כל הנתונים יושבים על המחשב הזה בלבד. אין עותק בענן ואין ממי לבקש שחזור. הגדירו תיקיית גיבוי, ורצוי להעתיק אותה מדי פעם לכונן חיצוני.',
    keys: ['backup_dir', 'external_backup_reminder_days'],
  },
];
